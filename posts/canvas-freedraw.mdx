---
title: canvas 태그를 활용하여 칠판 기능 구현하기
date: 2025-04-03
---
...
이 문제를 해결하기 위해 일정 이상의 거리를 이동했을 때만 그리기를 하여 최적화해볼 수 있습니다. 여기서 이동한 거리를 넓게 설정할수록 성능은 좋아지지만 선의 퀄리티는 떨어지게 됩니다. 그렇기 때문에 성능과 퀄리티를 적절히 조절할 수 있는 값을 찾는 것이 중요합니다. 제가 직접 값을 조정해가며 테스트해본 결과로는 `2` 정도가 적절한 것으로 보였습니다.
