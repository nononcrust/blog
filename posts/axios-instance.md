...
axios는 http 요청을 쉽게 처리할 수 있도록 도와주는 라이브러리입니다. 인터셉터, 타임아웃 등 편리한 기능들을 제공해주기 때문에 많은 프로젝트에서 사용되고 있습니다. 하지만 실제 프로젝트에서 axios를 사용하다보면 몇가지 불편한 점을 찾아볼 수 있는데요, 아래는 이를 개선해주는 코드입니다.
